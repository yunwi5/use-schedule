    ...
    return (
        <>
            <article
                ...
                className={`z-20 absolute left-[50%] w-[94%] top-0 ${statusBgClass} ${hoverBgClass} ${borderClass} 
                                    px-2 py-1 flex flex-col gap-2 text-slate-600 border-[1px] rounded-md cursor-pointer transition-all shadow-sm hover:z-30 hover:shadow-lg ${classes.card}`}
            >
