...
const Footer: React.FC<{ className: string }> = ({ className }) => {
	const iconClass = 'transition-all cursor-pointer hover:text-blue-700 hover:scale-110';
	...
	return (
		<footer
			className={`w-full flex-col gap-3 md:flex-row flex justify-between items-center md:items-start mt-6 md:px-4 lg:px-8 pt-4 border-t-2 border-slate-300 ${className}`}
		>
