		...
		<Modal onClose={onClose} classes={`${classes.modal}`}>
			...
			<div className={classes.container}>
				{templates.map((temp) => (
					<div
						key={temp.id}
						className={`${classes.template} ${selectedTemp?.id === temp.id
							? classes.selected
							: ''}`}
			...
			{selectedTemp && (
				<p className={classes.message}>
					...
					All tasks & sub tasks of your template <span>&quot;{selectedTemp.name}&quot; </span> will be imported to the week beginning at 
