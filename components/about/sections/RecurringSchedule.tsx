...
const RecurringSchedule: React.FC = () => {
    ...
    const checkList = [
        ...
        <>
            <mark>Customize the recurring interval</mark> according to your needs i.e. every
            week, month or year
        </>,
        <>
            <mark>All the properties</mark> of your event and task will be{' '}
            <mark>duplicated</mark> and will be <mark>added</mark> to your calendar &
            planner&nbsp;
    ...
    const features: FeatureBox[] = [
        {
            ...
            paragraphs: [
                <>
                    ...
                    like title, description and location, you can do it in{' '}
                    <mark>once place!</mark>
                </>,
                <>
                    You can <mark>optionally edit</mark> the properties of all generated
                    schedules in the <mark>recurring item page</mark>.
                </>,
            ],
        },
        {
            ...
            paragraphs: [
                <>
                    If you add wrong event or task accidently, or if you want to delete your
                    events or tasks, you can <mark>optionally delete</mark> all{' '}
                    <mark>duplicated</mark>
                    schedules at once by deleting the one in the{' '}
                    <mark>recurring item page</mark>.
                </>,
            ],
        },
    ];
