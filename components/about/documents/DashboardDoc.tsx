...
const checkList = [
    <>
        <mark>Weekly data summary</mark> including weekly workload, weekly completion rate etc.
    </>,
    <>
    ...
    <>
        Your schedule <mark>trend summary</mark> and <mark>progress summary</mark> that you can
        check in a minute.
    </>,
];
...
const features: FeatureBox[] = [
    {
        heading: (
            <>
                <FontAwesomeIcon icon={faChartLineUp} className={'mr-2'} /> Trend comparison
                across periods
            </>
        ),
    ...
    },
    {
        heading: (
            <>
                <FontAwesomeIcon icon={faCalendarDays} className={'mr-2'} /> Time Travel With
                mini calendar
            </>
        ),
        ...
        paragraphs: [
            <>
                The <mark>mini calendar</mark> in our dashboard basically allows you to time{' '}
                <mark>travel in different periods</mark> you navigate to.
            </>,
            <>
    ...
    },
    {
        heading: (
            <>
                <FontAwesomeIcon icon={faCalendarCircleExclamation} className={'mr-2'} /> View
                upcoming schedules
            </>
        ),
        ...
        paragraphs: [
            ...
            <>
                It is useful to find out <mark>which events and tasks</mark> you had in that{' '}
                <mark>specific period</mark> by using it alongside with the{' '}
    ...
    },
    {
        ...
        paragraphs: [
            <>
                ...
                <mark>summary of your template time table</mark> you defined. It shows total
                tasks, total hours you spend, as well as its importance.
            </>,
            <>
                You can <Link href={getNewTemplateLink()}>make your own time table</Link> that
                defines <mark>weekly schedules</mark> that are repetitive, then import them in
                your planner to <mark>save your planning time</mark>.
            </>,
        ],
    },
];
