    ...
    return (
        <TableCard className={`xl:w-[70%] min-h-[10rem] overflow-hidden !border-0`}>
            <table className={`w-full flex flex-col`}>
                <thead className={`flex text-base lg:text-lg bg-blue-100 text-slate-600/90`}>
                    <th className={`basis-2/4 sm:basis-4/12 font-semibold hover:bg-blue-200 py-2`}>
                        <span className={`hidden sm:inline`}>Weeky</span> Time Tables
                    </th>
                    <th
                    ...
                    <th className={`basis-1/4 sm:basis-2/12 font-semibold hover:bg-blue-200 py-2`}>
                        Tasks
                    </th>
                    <th className={`basis-1/4 sm:basis-3/12 font-semibold hover:bg-blue-200 py-2`}>
